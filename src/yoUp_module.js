...
export class YoUp {
  ...
  open(params) {
      ...
      if (params.width) {
          this.settings.width = params.width;
      } else {
  ...
  _createModal() {
      ...
      let modal =
          ...
          `<div class="modal-dialog" role="document" ${this.settings.width ? 'style="max-width: ' + this.settings.width + ';"' : ''}>` +
              `<div class="modal-content" style="${radius}">` +
                  header +
                  `<div class="modal-body" style="background-color: ${this.settings.contentBg};">${this.settings.content}</div>` +
                  footer +
              `</div>` +
          `</div>` +
          `</div>`;
